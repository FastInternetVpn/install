...
wget https://github.com/FastInternetVpn/pweb/raw/painel/install/correct.sql > /dev/null 2>&1
cd || exit
clear
echo ""
echo -e "\033[1;33mADICIONAR BANCO DE DADOS CONECTA AO PAINELWEB FAST INTERNET VPN!\033[0m" 
echo ""
